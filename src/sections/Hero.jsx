        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:pt-56 lg:pb-40">
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">
              Julian Caminaur Fullstack Web Developer
            </h1>
            <p className="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">
              I’m a full-stack web developer focused on creating clean,
              reliable, and efficient web solutions. I enjoy bringing ideas to
              life with a straightforward and professional approach.
            </p>
